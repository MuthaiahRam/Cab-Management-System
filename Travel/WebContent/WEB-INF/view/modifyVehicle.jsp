...
<body>
<CENTER><h2>MODIFY VEHICLE</h2></CENTER>
<form:form method="post" action="modifyVehicle.html" modelAttribute="VehicleIds">
...
<td><form:radiobutton path="vehicleBean.vehicleID" value="${id.vehicleID}" /></td></tr>


</c:forEach>
</table>
<CENTER><input type="submit" value="Modify Vehicle"/></CENTER>
</form:form>
